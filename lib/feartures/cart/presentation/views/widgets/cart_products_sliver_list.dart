...
class CartProductsSliverList extends StatelessWidget {
  const CartProductsSliverList({super.key, required this.cartEntities});
  final List<CartItemEntity> cartEntities;
  @override
    ...
    return SliverList.separated(
      ...
      itemBuilder: (context, index) {
        return Padding(
          ...
          child: CartProductItem(cartItemEntity: cartEntities[index]),
        );
      },
    );
  }
